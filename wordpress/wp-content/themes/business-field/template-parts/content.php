...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<?php
	$archive_layout          = business_field_get_option( 'archive_layout' );
	$archive_image           = business_field_get_option( 'archive_image' );
	$archive_image_alignment = business_field_get_option( 'archive_image_alignment' );
	?>
			...
			<div class="entry-content">
				...
				<?php if ( 'full' === $archive_layout ) : ?>
					...
					the_content( sprintf(
						...
						wp_kses( __( 'Continue reading %s <span class="meta-nav">&rarr;</span>', 'business-field' ), array( 'span' => array( 'class' => array() ) ) ),
