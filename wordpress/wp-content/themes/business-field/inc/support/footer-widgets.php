 ...
 * @since 1.0.0
 */
class Business_Field_Footer_Widgets {
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'business_field';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'business-field' ), $i ),
...
// Initialize.
$business_field_footer_widgets = new Business_Field_Footer_Widgets();
