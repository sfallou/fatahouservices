...
if ( ! function_exists( 'business_field_is_featured_slider_active' ) ) :
	 ...
	 */
	function business_field_is_featured_slider_active( $control ) {
...
if ( ! function_exists( 'business_field_is_featured_slider_caption_active' ) ) :
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function business_field_is_featured_slider_caption_active( $control ) {
...
if ( ! function_exists( 'business_field_is_featured_page_slider_active' ) ) :
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function business_field_is_featured_page_slider_active( $control ) {
...
if ( ! function_exists( 'business_field_is_image_in_archive_active' ) ) :
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function business_field_is_image_in_archive_active( $control ) {
