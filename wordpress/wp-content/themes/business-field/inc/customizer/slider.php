...
$default = business_field_get_default_theme_options();

// Add Panel.
$wp_customize->add_panel( 'theme_slider_panel',
	array(
	'title'      => __( 'Featured Slider', 'business-field' ),
	'priority'   => 100,
...
$wp_customize->add_section( 'section_theme_slider_type',
	array(
	'title'      => __( 'Slider Type', 'business-field' ),
	'priority'   => 100,
	'capability' => 'edit_theme_options',
...
$wp_customize->add_setting( 'theme_options[featured_slider_status]',
	...
	'capability'        => 'edit_theme_options',
	'sanitize_callback' => 'business_field_sanitize_select',
	)
);
$wp_customize->add_control( 'theme_options[featured_slider_status]',
	array(
	'label'    => __( 'Enable Slider On', 'business-field' ),
	'section'  => 'section_theme_slider_type',
	'type'     => 'select',
	'priority' => 100,
	'choices'  => business_field_get_featured_slider_content_options(),
	)
);
...
$wp_customize->add_control( 'theme_options[featured_slider_type]',
	array(
	'label'           => __( 'Select Slider Type', 'business-field' ),
	'section'         => 'section_theme_slider_type',
	'type'            => 'select',
	'priority'        => 100,
	'choices'         => business_field_get_featured_slider_type(),
	'active_callback' => 'business_field_is_featured_slider_active',
	)
);
...
$wp_customize->add_setting( 'theme_options[featured_slider_number]',
	...
	'sanitize_callback' => 'business_field_sanitize_number_range',
	)
);
$wp_customize->add_control( 'theme_options[featured_slider_number]',
	array(
	'label'           => __( 'No of Slides', 'business-field' ),
	'description'     => __( 'Enter number between 1 and 10. Save and refresh the page if No of Slides is changed.', 'business-field' ),
	'section'         => 'section_theme_slider_type',
	'type'            => 'number',
	'priority'        => 100,
	'active_callback' => 'business_field_is_featured_slider_active',
...
$featured_slider_number = absint( business_field_get_option( 'featured_slider_number' ) );
...
if ( $featured_slider_number > 0 ) {
	for ( $i = 1; $i <= $featured_slider_number; $i++ ) {
		...
		$wp_customize->add_control(
			new Business_Field_Heading_Control( $wp_customize, "theme_options[featured_slider_page_heading_$i]",
				array(
					'label'           => __( 'Slide', 'business-field' ) . ' #' . $i,
					'section'         => 'section_theme_slider_type',
					'settings'        => "theme_options[featured_slider_page_heading_$i]",
					'priority'        => 100,
					'active_callback' => 'business_field_is_featured_page_slider_active',
				)
			)
		);
		...
		$wp_customize->add_setting( "theme_options[featured_slider_page_$i]",
			...
			'capability'        => 'edit_theme_options',
			'sanitize_callback' => 'business_field_sanitize_dropdown_pages',
			)
		);
		...
		$wp_customize->add_control( "theme_options[featured_slider_page_caption_alignment_$i]",
			array(
			'label'           => __( 'Caption Alignment', 'business-field' ),
			'section'         => 'section_theme_slider_type',
			'type'            => 'select',
			'priority'        => 100,
			'choices'         => business_field_get_slider_caption_alignment_options(),
			'active_callback' => 'business_field_is_featured_page_slider_active',
			)
		);
	} // End for loop.
...
$wp_customize->add_section( 'section_theme_slider_options',
	array(
	'title'      => __( 'Slider Options', 'business-field' ),
	'priority'   => 100,
	'capability' => 'edit_theme_options',
	'panel'      => 'theme_slider_panel',
	)
...
$wp_customize->add_setting( 'theme_options[featured_slider_transition_effect]',
	...
	'capability'        => 'edit_theme_options',
	'sanitize_callback' => 'business_field_sanitize_select_liberal',
	)
);
$wp_customize->add_control( 'theme_options[featured_slider_transition_effect]',
	array(
	'label'    => __( 'Transition Effect', 'business-field' ),
	'section'  => 'section_theme_slider_options',
	'type'     => 'select',
	'priority' => 100,
	'choices'  => business_field_get_featured_slider_transition_effects(),
	)
);
...
$wp_customize->add_control( 'theme_options[featured_slider_transition_delay]',
	array(
	'label'       => __( 'Transition Delay', 'business-field' ),
	'description' => __( 'in seconds', 'business-field' ),
	'section'     => 'section_theme_slider_options',
	'type'        => 'number',
	'priority'    => 100,
	'input_attrs' => array( 'min' => 1, 'max' => 10, 'step' => 1, 'style' => 'width: 55px;' ),
...
$wp_customize->add_control( 'theme_options[featured_slider_transition_duration]',
	array(
	'label'       => __( 'Transition Duration', 'business-field' ),
	'description' => __( 'in seconds', 'business-field' ),
	'section'     => 'section_theme_slider_options',
	'type'        => 'number',
	'priority'    => 100,
...
$wp_customize->add_setting( 'theme_options[featured_slider_enable_caption]',
	...
	'capability'        => 'edit_theme_options',
	'sanitize_callback' => 'business_field_sanitize_checkbox',
	)
);
$wp_customize->add_control( 'theme_options[featured_slider_enable_caption]',
	array(
	'label'    => __( 'Enable Caption', 'business-field' ),
	'section'  => 'section_theme_slider_options',
	'type'     => 'checkbox',
	'priority' => 100,
	)
...
$wp_customize->add_control( 'theme_options[featured_slider_caption_alignment]',
	...
	'priority'        => 100,
	'choices'         => business_field_get_slider_caption_alignment_options(),
	'active_callback' => 'business_field_is_featured_slider_caption_active',
	)
);
...
$wp_customize->add_control( 'theme_options[featured_slider_enable_arrow]',
	array(
	'label'    => __( 'Enable Arrow', 'business-field' ),
	'section'  => 'section_theme_slider_options',
	'type'     => 'checkbox',
	'priority' => 100,
	)
...
$wp_customize->add_control( 'theme_options[featured_slider_enable_pager]',
	array(
	'label'    => __( 'Enable Pager', 'business-field' ),
	'section'  => 'section_theme_slider_options',
	'type'     => 'checkbox',
	'priority' => 100,
	)
...
$wp_customize->add_control( 'theme_options[featured_slider_enable_autoplay]',
	array(
	'label'    => __( 'Enable Autoplay', 'business-field' ),
	'section'  => 'section_theme_slider_options',
	'type'     => 'checkbox',
	'priority' => 100,
	)
...
$wp_customize->add_control( 'theme_options[featured_slider_enable_overlay]',
	array(
	'label'    => __( 'Enable Overlay', 'business-field' ),
	'section'  => 'section_theme_slider_options',
	'type'     => 'checkbox',
	'priority' => 100,
	)
