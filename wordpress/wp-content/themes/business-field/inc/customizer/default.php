...
if ( ! function_exists( 'business_field_get_default_theme_options' ) ) :
	 ...
	 */
	function business_field_get_default_theme_options() {
		...
		// Footer.
		$defaults['copyright_text']        = esc_html__( 'Copyright &copy; All rights reserved.', 'business-field' );
		$defaults['show_social_in_footer'] = false;

		// Blog.
		$defaults['blog_title']         = esc_html__( 'Blog', 'business-field' );
		$defaults['excerpt_length']     = 40;
		$defaults['read_more_text']     = esc_html__( 'Read More', 'business-field' );
		...
		$defaults['featured_slider_read_more_text']      = esc_html__( 'Read More', 'business-field' );

		// Pass through filter.
		$defaults = apply_filters( 'business_field_filter_default_theme_options', $defaults );
		return $defaults;
	}
