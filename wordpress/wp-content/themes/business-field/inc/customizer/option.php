...
$wp_customize->add_panel( 'theme_option_panel',
	array(
	'title'      => __( 'Theme Options', 'business-field' ),
	'priority'   => 100,
...
$wp_customize->add_section( 'section_header',
	array(
	'title'      => __( 'Header Options', 'business-field' ),
	'priority'   => 100,
	'capability' => 'edit_theme_options',
...
$wp_customize->add_control( 'theme_options[show_title]',
	array(
	'label'    => __( 'Show Site Title', 'business-field' ),
...
$wp_customize->add_control( 'theme_options[show_tagline]',
	array(
	'label'    => __( 'Show Tagline', 'business-field' ),
	'section'  => 'section_header',
	'type'     => 'checkbox',
	'priority' => 100,
	)
...
$wp_customize->add_control( 'theme_options[search_in_header]',
	array(
		'label'    => __( 'Enable Search Form', 'business-field' ),
		'section'  => 'section_header',
		'type'     => 'checkbox',
		'priority' => 100,
	)
...
$wp_customize->add_section( 'section_layout',
	array(
	'title'      => __( 'Layout Options', 'business-field' ),
	'priority'   => 100,
	'capability' => 'edit_theme_options',
	'panel'      => 'theme_option_panel',
	)
...
$wp_customize->add_control( 'theme_options[global_layout]',
	array(
	'label'    => __( 'Global Layout', 'business-field' ),
	'section'  => 'section_layout',
	'type'     => 'select',
	'choices'  => business_field_get_global_layout_options(),
	'priority' => 100,
	)
);
...
$wp_customize->add_control( 'theme_options[archive_layout]',
	array(
	'label'    => __( 'Archive Layout', 'business-field' ),
	'section'  => 'section_layout',
	'type'     => 'select',
	'choices'  => business_field_get_archive_layout_options(),
	'priority' => 100,
	)
);
...
$wp_customize->add_control( 'theme_options[archive_image]',
	array(
	'label'    => __( 'Image in Archive', 'business-field' ),
	'section'  => 'section_layout',
	'type'     => 'select',
	'choices'  => business_field_get_image_sizes_options( true, array( 'disable', 'thumbnail', 'large' ), false ),
	'priority' => 100,
	)
);
...
$wp_customize->add_control( 'theme_options[archive_image_alignment]',
	array(
	'label'           => __( 'Image Alignment in Archive', 'business-field' ),
	'section'         => 'section_layout',
	'type'            => 'select',
	'choices'         => business_field_get_image_alignment_options(),
	'priority'        => 100,
	'active_callback' => 'business_field_is_image_in_archive_active',
	)
);
...
$wp_customize->add_control( 'theme_options[single_image]',
	array(
	'label'    => __( 'Image in Single Post/Page', 'business-field' ),
	'section'  => 'section_layout',
	'type'     => 'select',
	'choices'  => business_field_get_image_sizes_options( true, array( 'disable', 'large' ), false ),
	'priority' => 100,
	)
);
...
$wp_customize->add_section( 'section_home_page',
	array(
	'title'      => __( 'Home Page Options', 'business-field' ),
	'priority'   => 100,
	'capability' => 'edit_theme_options',
	'panel'      => 'theme_option_panel',
	)
...
$wp_customize->add_control( 'theme_options[home_content_status]',
	array(
	'label'       => __( 'Show Home Content', 'business-field' ),
	'description' => __( 'Check this to show page content in Home page.', 'business-field' ),
...
$wp_customize->add_section( 'section_footer',
	array(
	'title'      => __( 'Footer Options', 'business-field' ),
	'priority'   => 100,
	'capability' => 'edit_theme_options',
	'panel'      => 'theme_option_panel',
	)
...
$wp_customize->add_control( 'theme_options[copyright_text]',
	array(
	'label'    => __( 'Copyright Text', 'business-field' ),
...
$wp_customize->add_control( 'theme_options[show_social_in_footer]',
	array(
		'label'    => __( 'Show Social Icons', 'business-field' ),
		'section'  => 'section_footer',
		'type'     => 'checkbox',
		'priority' => 100,
	)
...
$wp_customize->add_section( 'section_blog',
	array(
	'title'      => __( 'Blog Options', 'business-field' ),
	'priority'   => 100,
	'capability' => 'edit_theme_options',
	'panel'      => 'theme_option_panel',
	)
...
$wp_customize->add_control( 'theme_options[blog_title]',
	array(
	'label'    => __( 'Blog Title', 'business-field' ),
...
$wp_customize->add_setting( 'theme_options[excerpt_length]',
	...
	'capability'        => 'edit_theme_options',
	'sanitize_callback' => 'business_field_sanitize_positive_integer',
	)
);
...
$wp_customize->add_control( 'theme_options[exclude_categories]',
	array(
	'label'       => __( 'Exclude Categories in Blog', 'business-field' ),
	'description' => __( 'Enter category ID to exclude in Blog Page. Separate with comma if more than one', 'business-field' ),
	'section'     => 'section_blog',
	'type'        => 'text',
	'priority'    => 100,
	)
...
$wp_customize->add_section( 'section_breadcrumb',
	array(
	'title'      => __( 'Breadcrumb Options', 'business-field' ),
	'priority'   => 100,
	'capability' => 'edit_theme_options',
	'panel'      => 'theme_option_panel',
	)
...
$wp_customize->add_control( 'theme_options[breadcrumb_type]',
	array(
	'label'       => __( 'Breadcrumb Type', 'business-field' ),
	'section'     => 'section_breadcrumb',
	'type'        => 'select',
	'choices'     => business_field_get_breadcrumb_type_options(),
	'priority'    => 100,
	)
);
